...
function LandingPage({onStart,scrollToRef}){
  ...
  return<>
    ...
    <section className="sec sec-c" id="precios" ref={scrollToRef}><Anim><div className="sec-l">Precios</div><h2 className="sec-t">Elige tu plan de valoración</h2><p className="sec-sub">Sin sorpresas. Pago único, sin suscripciones.</p></Anim><Anim><div className="pgrid">
      ...
      <div className="pcard"><div className="p-name">Informe Profesional</div><div className="p-amt">299€ <span>+ IVA</span></div><div className="p-desc">Análisis en profundidad con benchmarking, sensibilidad y recomendaciones de valor.</div><div className="p-feats"><div className="p-feat"><Ck/> Todo lo del plan Esencial</div><div className="p-feat"><Ck/> Benchmarking sectorial</div><div className="p-feat"><Ck/> Análisis de sensibilidad</div><div className="p-feat"><Ck/> Recomendaciones de Creación de Valor</div><div className="p-feat"><Ck/> Nota del Analista</div></div><button className="p-btn p-btn-o" onClick={onStart}>Obtener informe profesional</button></div>
    </div></Anim></section>
